                ...
                <div className="row g-4">
                    {sampleProjects.map((p) => (
                        <div key={p.id} className="col-md-4">
                            <article className={`card project-card accent-${p.accent}`} data-aos="fade-up">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex gap-2 align-items-center">
                                        <small className="text-muted me-auto">{p.tech.join(' • ')}</small>
                                        <a className="btn btn-sm btn-outline-light" href={p.github}>
                                            Code
                                        </a>
